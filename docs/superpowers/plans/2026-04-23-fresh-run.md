...
In `test/controller_daemon.jl`, add this helper near the other temp-fixture helpers:
...
- the crash recovery test fails because `refresh_worker_pool!` does not exist yet
